        ...
        <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex-1 text-center lg:text-left pt-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 lg:justify-start mb-10">
              <Link
                href="/listings"
                className={cn(buttonVariants({ size: "lg" }), "h-14 px-10 text-lg shadow-2xl shadow-primary/30 rounded-full hover:scale-105 transition-all")}
              >
                Explore Listings
              </Link>
              <Link
                href="/listings/new"
                className={cn(buttonVariants({ size: "lg", variant: "outline" }), "h-14 px-10 text-lg rounded-full hover:bg-muted transition-all")}
              >
                Post an Ad
              </Link>
            </div>
            ...
            {/* Smart Search Bar */}
            <div className="max-w-xl w-full glass p-2 rounded-full shadow-2xl hidden md:flex items-center gap-2 border border-white/40">
              <div className="flex-1 flex items-center gap-3 px-4 border-r border-muted">
                <Search className="size-5 text-primary" />
                <input 
                  type="text" 
                  placeholder="Search breed, city..." 
              ...
              <button className="h-11 px-6 rounded-full bg-primary text-white text-sm font-black shadow-lg shadow-primary/20 hover:scale-105 transition-all">
                Search
              </button>
            </div>
            ...
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)]">
              ...
              <div className="absolute bottom-8 left-8 right-8 glass p-6 rounded-2xl shadow-2xl">
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 overflow-hidden rounded-full border-2 border-white/50 shadow-lg">
                    <Image src="/lifestyle-pet.png" alt="User" width={48} height={48} className="object-cover" />
                  </div>
